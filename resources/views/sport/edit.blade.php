							...
							<div class="card-body">
								<div class="border p-4 rounded">
									...
									<div class="row mb-3">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" id="title" placeholder="Title" name="title" value="{{$sport->title}}">
										</div>
									</div>
									<div class="row mb-3">
										<label for="Capacity" class="col-sm-3 col-form-label">Capacity</label>
										<div class="col-sm-9">
											<input type="number" class="form-control" id="Capacity" placeholder="Capacity"  name="capacity" value="{{$sport->capacity}}">
										</div>
									</div>
									<div class="row mb-3">
										<label for="price" class="col-sm-3 col-form-label">Price</label>
										<div class="col-sm-9">
											<input type="number" class="form-control" id="price" placeholder="Author" name="price" step="0.00" value="{{$sport->price}}">
										</div>
									</div>
                                    <div class="row mb-3">
                                        ...
                                        <select name="status" class="form-select mb-3" aria-label="Default select example"  id="status" >
                                            <option selected>{{$sport->status}}</option>
									...
									<div class="row mb-3">
										...
										<div class="col-sm-9">
											<textarea class="form-control" id="Description" rows="2" placeholder="Description" name="description">{{$sport->title}}</textarea>
										</div>
									</div>
