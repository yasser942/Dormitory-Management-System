							...
							<div class="card-body">
								<div class="border p-4 rounded">
									<div class="card-title d-flex align-items-center">
										...
										<h5 class="mb-0 text-primary">Register for Sport</h5>
									</div>
									<hr/>
                                    <form action="{{ route('student.sports.register',$sport->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf

									<div class="row mb-3">
										<label for="start_date" class="col-sm-3 col-form-label">Start Date</label>
										<div class="col-sm-9">
                                            <input type="text" class="form-control datepicker" placeholder="Start Date" id="date" name="start_date" value="{{old('start_date')}}"/>
										</div>
									</div>
                                        <div class="row mb-3">
                                            <label for="date" class="col-sm-3 col-form-label">End Date</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control datepicker" placeholder="End Date" id="date" name="end_date" value="{{old('end_date')}}"/>
                                            </div>
                                        </div>
