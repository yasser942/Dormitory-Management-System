							...
							<div class="card-body">
								<div class="border p-4 rounded">
									<div class="card-title d-flex align-items-center">
										<div><i class="bx bx-home-circle me-1 font-22 text-primary"></i>
										</div>
										<h5 class="mb-0 text-primary">Assign to Room</h5>
									</div>
									<hr/>
                                    <form action="{{route('students.assign_room',$id)}}" method="POST">
                                        @csrf
									...
									<div class="row mb-3">
										...
										<div class="col-sm-9">
                                            <input type="text" class="form-control datepicker" placeholder="Start Date" id="startDate" name="start_date" value="{{old('start_date')}}"/>
										</div>
									</div>

                                    <div class="row mb-3">
                                        <label for="endtDate" class="col-sm-3 col-form-label">End Date</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control datepicker" placeholder="End Date" id="endDate" name="end_date" value="{{old('end_date')}}"/>
                                        </div>
                                    </div>
