        ...
        <div class="card">
            <div class="card-body">
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    ...
                    <div class="ms-auto"><a href="{{route('rooms.create')}}"
                                            class="btn btn-primary radius-30 mt-2 mt-lg-0"><i
                                class="bx bxs-plus-square"></i>Add New Room</a></div>
                </div>
                    ...
                    <table class="table mb-0">
                        ...
                        @foreach($rooms as  $room)
                            <tr>
                                ...
                                <td><a type="button" href="{{route('rooms.show',$room->id)}}"
                                       class="btn btn-primary btn-sm radius-30 px-4">View Details</a></td>
                                <td>
                                    <div class="col">
                                        <div class="dropdown">
                                            <button class="btn btn-secondary dropdown-toggle radius-30 px-4"
                    ...
                    <nav class="mt-4" aria-label="Page navigation example">
                        <ul class="pagination round-pagination">
                            ...
                            @if ($rooms->hasMorePages())
                                <li class="page-item"><a class="page-link" href="{{ $rooms->nextPageUrl() }}">Next</a>
                                </li>
                            @else
