						...
						<div class="card">
							<div class="card-body">
                                <form action="{{route('rooms.update',$room->id)}}" method="POST">
                                    ...
                                    <input value="{{$room->room_number}}" name="room_number" class="form-control mb-3" type="text" placeholder="Ex. Room-1" aria-label="default input example" id="roomNumber">
                                    ...
                                    <input value="{{$room->price}}" name="price" class="form-control mb-3" type="number" placeholder="100.00" aria-label="default input example" id="price" min="0">
                                    <label for="description" class="form-label">Description</label>
                                    <textarea  class="form-control" id="description" placeholder="Enter Description" rows="3" name="description">{{$room->description}}</textarea>
