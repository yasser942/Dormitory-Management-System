...
@section('admin')
                ...
                <div class="card radius-10 overflow-hidden w-100">
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center mb-0">
                            ...
                            <tr>
                                <td><i class="bx bxs-circle me-2" style="color: #02ba5a"></i>Unregistered Sports</td>
                                <td id="data1"> {{$totalSports-$registeredSportsCount}} </td>
                            </tr>
                            <tr>
                                <td><i class="bx bxs-circle me-2" style="color: #d31e1e"></i>Registered Sports</td>
                                <td id="data2"> {{$registeredSportsCount}} </td>
                            </tr>
    ...
    <script>
        var visitorData2 = @json($registeredSportsCountValuesPreviousMonth);

        var visitorData = @json($registeredSportsCountValuesCurrentMonth);
