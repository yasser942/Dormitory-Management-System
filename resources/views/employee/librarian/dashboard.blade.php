...
@section('admin')
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center mb-0">
                            ...
                            <tr>
                                ...
                                <td id="data1"> {{$totalBooks-$borrowedBooksCount}} </td>
                            </tr>
                            <tr>
                                <td><i class="bx bxs-circle me-2" style="color: #d31e1e"></i>Borrowed  Books</td>
                                <td id="data2"> {{$borrowedBooksCount}} </td>
                            </tr>
    ...
    <script>
        var visitorData2 = @json($borrowedBooksCountValuesPreviousMonth);

        var visitorData = @json($borrowedBooksCountValuesCurrentMonth);
