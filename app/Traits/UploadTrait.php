...
trait UploadTrait{
    public function verifyAndStoreImage(Request $request, $inputname , $foldername , $disk, $imageable_id, $imageable_type ,$name) {
        ...
        if( $request->hasFile( $inputname ) ) {
            ...
            $filename = $name.$imageable_id.'.'. $photo->getClientOriginalExtension();
